...
import { FullCardDescription } from '.';
import { CloseIcon } from '../../assets/CloseIcon';

describe('Full Card Description', () => {
  test('Renders correct data in card', () => {
    const item = {
      mal_id: 1,
    ...
    render(<FullCardDescription item={item} setIsOpen={() => console.log(open)} />);
    expect(screen.getByText(`${item.title} | ${item.title_japanese}`)).toBeInTheDocument();
    expect(<CloseIcon fn={() => console.log(open)} />);
  });
});
